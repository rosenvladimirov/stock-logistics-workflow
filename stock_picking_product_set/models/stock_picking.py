...
class Picking(models.Model):
    ...
    def _compute_product_set_ids(self):
        ...
        for record in self:
            ...
            move_ids = record.move_ids.filtered(lambda r: r.product_set_id)
            for product_set_id, lines in groupby(move_ids.sorted(lambda r: r.product_set_id.id),
